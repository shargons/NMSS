...
GO
SELECT *
INTO [CFG_NMSS_PREPROD].[dbo].[Case_CType_Update]
FROM [NMSS_SRC].[CFG_NMSS_QA].[dbo].[vw_DW_CFG_CareMgmtDescription]  

SELECT * FROM [CFG_NMSS_PREPROD].[dbo].[Case_CType_Update]
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI2','CFG_NMSS_PREPROD','Case_CType_Update'
