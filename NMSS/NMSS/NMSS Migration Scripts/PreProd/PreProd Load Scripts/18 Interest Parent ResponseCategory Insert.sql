...
SELECT [Id]
  ...
  FROM [NMSS_SRC].[CFG_NMSS_QA].[dbo].[vw_DW_CFG_ResponseCategory_Interest]
GO
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI2','CFG_NMSS_PREPROD','Interest__c_ResponseCategory_LOAD'
