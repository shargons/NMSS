...
--DROP table InterestedCase__c_ResoT_Load
SELECT *
  INTO InterestedCase__c_ResoT_Load
  FROM [NMSS_SRC].[CFG_NMSS_QA].[dbo].[vw_DW_CFG_CaseInterestResoT]
GO

/******* Check Load table *********/
SELECT *
FROM InterestedCase__c_ResoT_Load

/******* Change ID Column to nvarchar(18) *********/
ALTER TABLE InterestedCase__c_ResoT_Load
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI2','CFG_NMSS_PREPROD','InterestedCase__c_ResoT_Load'

SELECT * FROM InterestedCase__c_TT_Load_Result where Error ='Operation Successful.'

select DISTINCT Error from InterestedCase__c_ResoT_Load_Result
...
SELECT ID INTO InterestedCase__c_DELETE FROM InterestedCase__c_ResoT_Load_Result WHERE Error = 'Operation Successful.'
...
FROM InterestedCase__c_ResoT_Load_Result
