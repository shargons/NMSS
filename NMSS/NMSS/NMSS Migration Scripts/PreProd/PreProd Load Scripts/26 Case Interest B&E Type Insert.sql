...
--DROP table InterestedCase__c_Ltype_Load
SELECT *
  INTO InterestedCase__c_BEtype_Load
  FROM [NMSS_SRC].[CFG_NMSS_QA].[dbo].[vw_DW_CFG_CaseInterestB&EType]

/******* Check Load table *********/
SELECT *
FROM InterestedCase__c_BEtype_Load

/******* Change ID Column to nvarchar(18) *********/
ALTER TABLE InterestedCase__c_BEtype_Load
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI2','CFG_NMSS_PREPROD','InterestedCase__c_BEtype_Load'

SELECT * FROM InterestedCase__c_Ltype_Load_Result where Error ='Operation Successful.'
...
FROM InterestedCase__c_BEtype_Load_Result
