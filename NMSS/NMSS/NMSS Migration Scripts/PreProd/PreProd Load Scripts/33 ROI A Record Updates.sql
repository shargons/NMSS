...
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_ExpiryDate_Update'

SELECT * FROM Consent_for_Release_of_Information__c_ExpiryDate_Update
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_ExpiryDate_Update_2'
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_SentDate_Update'
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_SentDate_Update_2'

SELECT * FROM Consent_for_Release_of_Information__c_SentDate_Update_Result
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_Status_Update'
