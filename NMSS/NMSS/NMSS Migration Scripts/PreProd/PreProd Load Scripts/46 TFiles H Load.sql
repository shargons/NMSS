...
--====================================================================
DROP TABLE ContentVersion_ROI_H_Insert
...
--====================================================================
/******* Change ID Column to nvarchar(18) *********/
ALTER TABLE ContentVersion_ROI_H_Insert
ALTER COLUMN ID NVARCHAR(18)

/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:soap,batchsize(1)','CFG_NMSS_PREPROD','ContentVersion_ROI_H_Insert'

SELECT *
--INTO ContentVersion_ROI_F_Insert_2
FROM ContentVersion_ROI_H_Insert_Result 
where Error <> 'Operation Successful.'


select count(*), Error from ContentVersion_ROI_H_Insert_Result GROUP BY Error
...
INSERT INTO ContentVersion_DELETE(Id) SELECT Id FROM ContentVersion_ROI_H_Insert_Result WHERE Error = 'Operation Successful.'
...
--====================================================================
 ...
 -- Case Files 
 DROP TABLE ContentVersion_CaseFile_H_Insert
...
SELECT
 ...
 INTO ContentVersion_CaseFile_H_Insert
 FROM [CFG_NMSS_PREPROD].[dbo].[T_CaseFiles] A
...
--====================================================================
/******* Change ID Column to nvarchar(18) *********/
ALTER TABLE ContentVersion_CaseFile_H_Insert
ALTER COLUMN ID NVARCHAR(18)

SELECT * FROM ContentVersion_CaseFile_H_Insert
 where FirstPublishLocationId IS NULL

/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:soap,batchsize(1)','CFG_NMSS_PREPROD','ContentVersion_CaseFile_H_Insert'

SELECT * FROM ContentVersion_CaseFile_H_Insert_Result where Error <> 'Operation Successful.'

SELECT * FROM ContentVersion_CaseFile_H_Insert_Result where Error LIKE '%could not find file%'

select count(*), Error from ContentVersion_CaseFile_H_Insert_Result GROUP BY Error