...
--- Expiry Date
--DROP TABLE Consent_for_Release_of_Information__c_M_ExpiryDate_Update
...
INTO Consent_for_Release_of_Information__c_M_ExpiryDate_Update
FROM 
(
...
FROM [CFG_NMSS_PREPROD].[dbo].[ContentVersion_ROI_M_Insert_Result]
where Title LIKE '%exp%'
)x

EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_M_ExpiryDate_Update'

SELECT * FROM Consent_for_Release_of_Information__c_M_ExpiryDate_Update_Result
WHERE Error <> 'Operation Successful.'

--- FORMAT EXP YYYY MM
--DROP TABLE Consent_for_Release_of_Information__c_M_ExpiryDate_Update_2
SELECT x.FirstPublishLocationId AS ID,IIF(ISDATE(x.ExpiryDate)=1,CAST(x.ExpiryDate AS date) ,NULL) AS Expiration_Date__c,NULL AS Date_Sent__c
INTO Consent_for_Release_of_Information__c_M_ExpiryDate_Update_2
FROM 
(
SELECT Title,FirstPublishLocationId,
IIF(LEN(SUBSTRING(Title,PATINDEX('%EXP%',Title)+4,4))=4,SUBSTRING(Title,PATINDEX('%EXP%',Title)+4,4),NULL) +'-'+
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_M_ExpiryDate_Update_2'



-- Sent Date
--DROP TABLE Consent_for_Release_of_Information__c_M_SentDate_Update
...
INTO Consent_for_Release_of_Information__c_M_SentDate_Update
FROM 
(
SELECT Title,FirstPublishLocationId,
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_M_SentDate_Update'

--DROP TABLE Consent_for_Release_of_Information__c_M_SentDate_Update_2
SELECT x.FirstPublishLocationId AS ID,IIF(ISDATE(x.SentDate)=1,CAST(x.SentDate AS date) ,NULL) AS Date_Sent__c,NULL AS Expiration_Date__c
INTO Consent_for_Release_of_Information__c_M_SentDate_Update_2
FROM 
(
SELECT Title,FirstPublishLocationId,
IIF(LEN(SUBSTRING(Title,PATINDEX('%sent%',Title)+5,4))=4,SUBSTRING(Title,PATINDEX('%sent%',Title)+5,4),NULL) +'-'+
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_M_SentDate_Update_2'

SELECT * FROM Consent_for_Release_of_Information__c_M_SentDate_Update_2_Result
WHERE Error <> 'Operation Successful.'

-- Status
--DROP TABLE Consent_for_Release_of_Information__c_M_Status_Update
SELECT x.FirstPublishLocationId AS ID,Status__c
INTO Consent_for_Release_of_Information__c_M_Status_Update
FROM 
(
SELECT Title,FirstPublishLocationId,
CASE
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_M_Status_Update'
...
--DROP TABLE Consent_for_Release_of_Information__c_M_Desc_Update
SELECT x.FirstPublishLocationId AS ID,Description_of_How_the_Info_Will_Be_Used__c
INTO Consent_for_Release_of_Information__c_M_Desc_Update
FROM 
(
SELECT Title,FirstPublishLocationId,
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PREPROD','Consent_for_Release_of_Information__c_M_Desc_Update'


SELECT * FROM Consent_for_Release_of_Information__c_M_Status_Update_Result
WHERE Error <> 'Operation Successful.'