...
SELECT  [Id]
      ...
      ,[Active__c]
      ,[Market__c]
INTO [CFG_NMSS_PROD].[dbo].Account_HH_LOAD
  FROM [CFG_NMSS_PROD].[dbo].[vw_DW_SFDC_Account_Household]
...
/******* Insert DBAmp Script *********/
EXEC SF_TableLoader 'Insert','CFG_NMSS_PROD','Account_HH_LOAD'
...
INSERT INTO [NMSS_PRD].[SFINTEGRATION].[dbo].[XREF_Account_Household]
           ([SFID]
           ,[DWID]
           ,[SystemOfCreation]
           ,[LastActionTaken]
...
INSERT INTO [CFG_NMSS_PROD].[dbo].[XREF_Account_Household]
           ([SFID]
           ,[DWID]
           ,[SystemOfCreation]
           ,[LastActionTaken]
