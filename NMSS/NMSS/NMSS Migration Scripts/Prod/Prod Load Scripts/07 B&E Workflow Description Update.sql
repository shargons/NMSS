...
FROM [NMSS_PRD].[CFG_NMSS_PROD].[dbo].[vw_DW_CFG_B&EDescription]

SELECT * FROM [CFG_NMSS_PROD].[dbo].[Case_Update]
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PROD','Case_Update'
