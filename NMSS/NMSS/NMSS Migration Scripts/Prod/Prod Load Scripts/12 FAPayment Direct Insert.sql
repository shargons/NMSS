...
SELECT F.[ID]
  ...
  FROM [NMSS_PRD].[CFG_NMSS_PROD].[dbo].[vw_DW_CFG_DirectFAPayment] F
	   ...
	   INNER JOIN [CFG_NMSS_PROD].[dbo].[XREF_FARequest] F2
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PROD','FA_Payment__c_Direct_Load'
...
SELECT DISTINCT
 ...
 /******* DBAmp Script *********/
EXEC SF_TableLoader 'Update:BULKAPI','CFG_NMSS_PROD','Case_FA_Open_Status_Update'
