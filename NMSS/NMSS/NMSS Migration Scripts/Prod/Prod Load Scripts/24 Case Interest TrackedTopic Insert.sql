...
SELECT A.*
  INTO InterestedCase__c_TT_Load_Rem
  FROM [NMSS_PRD].[CFG_NMSS_PROD].[dbo].[vw_DW_CFG_CaseInterestTT] A
...
/******* Check Load table *********/
SELECT *
FROM InterestedCase__c_TT_Load_Rem

/******* Change ID Column to nvarchar(18) *********/
ALTER TABLE InterestedCase__c_TT_Load_Rem
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PROD','InterestedCase__c_TT_Load_Rem'

SELECT * FROM InterestedCase__c_TT_Load_Result where Error <> 'Operation Successful.'

select DISTINCT Error from InterestedCase__c_TT_Load_Rem_Result
...
FROM InterestedCase__c_TT_Load_Result
