...
SELECT *
INTO [CFG_NMSS_PROD].dbo.FeedItem_T1_LOAD
FROM [NMSS_PRD].[CFG_NMSS_PROD].[dbo].[vw_DW_CFG_FeedItem_Tier1] F

-- L Type
SELECT *
INTO [CFG_NMSS_PROD].dbo.FeedItem_LType_LOAD
FROM [NMSS_PRD].[CFG_NMSS_PROD].[dbo].[vw_DW_CFG_FeedItem_LType]

-- P Type
SELECT *
INTO [CFG_NMSS_PROD].dbo.FeedItem_PType_LOAD
FROM [NMSS_PRD].[CFG_NMSS_PROD].[dbo].[vw_DW_CFG_FeedItem_PType]

-- R Type
SELECT *
INTO [CFG_NMSS_PROD].dbo.FeedItem_RType_LOAD
FROM [NMSS_PRD].[CFG_NMSS_PROD].[dbo].[vw_DW_CFG_FeedItem_RType]
...
-- Tier 1
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PROD','FeedItem_T1_LOAD'
...
ORDER BY ParentId
	...
	-- Tier 1 Errored Load
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PROD','FeedItem_Load_Err'

select count(*), Error from FeedItem_Load_Err_Result GROUP BY Error

SELECT Id,ParentID,CreatedById,CreatedDate,InsertedById,NetworkScope,Status,Type,Visibility,Body  
INTO FeedItem_T1_LOAD_2
FROM FeedItem_Load_Err_Result where Error <> 'Operation Successful.'



-- L Type
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PROD','FeedItem_LType_LOAD'
...
-- P Type
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PROD','FeedItem_PType_LOAD'
...
-- R Type
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PROD','FeedItem_RType_LOAD'
...
ORDER BY ParentId
	...
	-- R Type Errored Load
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PROD','FeedItem_RType_Load_Err'
