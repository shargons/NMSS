...
INTO [CFG_NMSS_PROD].dbo.Warning__c_LOAD
FROM [NMSS_PRD].[CFG_NMSS_PROD].[dbo].[vw_DW_SFDC_Warning__c] C
...
EXEC SF_TableLoader 'Insert:BULKAPI2','CFG_NMSS_PROD','Warning__c_LOAD'

SELECT * FROM Warning__c_LOAD_Result A
...
INSERT INTO [NMSS_PRD].[SFINTEGRATION].[dbo].[XREF_DW_SFDC_Warning__c]
           ([SFID]
           ,[DWID]
           ,[SystemOfCreation]
           ,[LastActionTaken]
...
SELECT
 ID
,[Data_Warehouse_ID__c]
INTO [CFG_NMSS_PROD].[dbo].[Warning_Lookup]
FROM Warning__c_LOAD_Result
WHERE Error = 'Operation Successful.'