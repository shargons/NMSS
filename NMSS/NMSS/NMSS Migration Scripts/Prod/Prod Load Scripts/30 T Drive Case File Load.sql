...
--DROP TABLE Case_TFile_Insert
 ...
 ,'Closed' AS Status
 INTO [CFG_NMSS_PROD].[dbo].Case_TFile_Insert
 FROM [CFG_NMSS_PROD].[dbo].[T_CaseFiles] A
  INNER JOIN [NMSS_PRD].[SFINTEGRATION].[dbo].[XREF_Contact] C
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PROD','Case_TFile_Insert'
...
SELECT 
 ...
 INTO ContentVersion_CaseFile_Insert
 FROM [CFG_NMSS_PROD].[dbo].[T_CaseFiles] A
...
--====================================================================
/******* Change ID Column to nvarchar(18) *********/
ALTER TABLE ContentVersion_CaseFile_Insert
ALTER COLUMN ID NVARCHAR(18)

SELECT * FROM ContentVersion_CaseFile_Insert

/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:soap,batchsize(1)','CFG_NMSS_PROD','ContentVersion_CaseFile_Insert'

SELECT * FROM ContentVersion_CaseFile_Insert_Result where Error <> 'Operation Successful.'
