...
,'LiteratureCategory'+CAST(LiteratureCategoryId AS NVARCHAR(50))	AS [DWUI_Literature_Type_ID__c] -- nvarchar(120)
...
,RC.UpdatedDate													    AS [LastModifiedDate]
	,CASE 
	 ...
	 ,0													AS IsActive__c
FROM [TommiPrd1].[dbo].[apfx_refLiteratureCategory] RC
