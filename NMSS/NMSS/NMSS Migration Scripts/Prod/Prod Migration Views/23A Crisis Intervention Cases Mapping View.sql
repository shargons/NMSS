...
CREATE or ALTER VIEW [dbo].[vw_DW_CFG_CrisisInterventionCases]  
AS
...
(
	...
	FROM TommiPrd1.dbo.apfx_Interaction I
		...
		left join TommiPrd1.dbo.apfx_ConstituentWarning cw
			on id.InteractionDetailId = cw.InteractionDetailId
	...
	WHERE I.ActiveFlag = 1 and cw.ConstituentWarningId is null
