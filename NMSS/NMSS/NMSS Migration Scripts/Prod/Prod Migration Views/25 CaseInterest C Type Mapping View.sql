...
CREATE OR ALTER VIEW [dbo].[vw_DW_CFG_CaseInterestCType]  
AS
...
SELECT
	...
	,C.[CreatedById]								AS [CreatedById]
	 ,1												AS [IsCurrent__c]
	 ,NULL										AS [Legacy_Interest__c]
	 ,I.ID										AS Interest__c
	 ,C.CreatedDate									AS [CreatedDate]
FROM [CFG_NMSS_PROD].[dbo].[vw_DW_CFG_CareManagementCases] C
