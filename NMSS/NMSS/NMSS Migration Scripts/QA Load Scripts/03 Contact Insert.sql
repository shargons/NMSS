...
INTO [CFG_NMSS_QA].dbo.Contact_Indiv_LOAD
FROM [NMSS_SRC].[CFG_NMSS_QA].[dbo].[vw_DW_SFDC_Contact] C
LEFT JOIN [CFG_NMSS_QA].dbo.[XREF_Account_Household] HL
...
EXEC SF_TableLoader 'Insert:BULKAPI2','CFG_NMSS_QA','Contact_Indiv_LOAD'
