...
INTO [CFG_NMSS_QA].dbo.npe4__Relationship__c_LOAD
FROM [NMSS_SRC].[CFG_NMSS_QA].[dbo].[vw_DW_SFDC_Relationship] C
INNER JOIN [CFG_NMSS_QA].dbo.[XREF_Contact] AL
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI2','CFG_NMSS_QA','npe4__Relationship__c_LOAD'
...
--====================================================================
INSERT INTO [CFG_NMSS_QA].[dbo].[XREF_Relationship]
           ([SFID]
           ,[DWID]
           ,[SystemOfCreation]
           ,[LastActionTaken]
