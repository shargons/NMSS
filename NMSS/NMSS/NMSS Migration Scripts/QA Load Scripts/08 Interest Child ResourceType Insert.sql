...
SELECT 
  ...
  FROM [NMSS_SRC].[CFG_NMSS_QA].[dbo].[vw_DW_CFG_ResourceType_Interest] I
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI2','CFG_NMSS_QA','Interest__c_ResourceType_LOAD'
...
FROM Interest__c_ResourceType_LOAD_Result
