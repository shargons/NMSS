...
SELECT [Id]
  ...
  FROM [NMSS_SRC].[CFG_NMSS_QA].[dbo].[vw_DW_CFG_LiteratureCategory_Interest]
GO
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI2','CFG_NMSS_QA','Interest__c_LiteratureCategory_LOAD'
...
INTO Interest_LiteratureCategory_Lookup
FROM Interest__c_LiteratureCategory_LOAD_Result
where Error = 'Operation Successful.'

SELECT * FROM Interest_LiteratureCategory_Lookup
