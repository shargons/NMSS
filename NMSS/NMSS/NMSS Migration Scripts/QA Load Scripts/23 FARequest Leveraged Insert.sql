...
SELECT 
  ...
  FROM [NMSS_SRC].[CFG_NMSS_QA].[dbo].[vw_DW_CFG_LeveragedFARequest] F
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI2','CFG_NMSS_QA','FA_Request__c_Leveraged_Load'

SELECT * FROM FA_Request__c_Leveraged_Load_Result where Error = 'Operation Successful.'
