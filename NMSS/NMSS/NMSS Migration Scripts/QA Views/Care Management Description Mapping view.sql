...
SELECT DISTINCT
	...
	,  ISNULL(I.Comments,'')+CHAR(10)+CHAR(10)+'DWUI Interaction Detail :' + CAST(cs.InteractionDetailId AS nvarchar)+CHAR(10)+'Care Management'+CHAR(10)+ISNULL(id.Comments,'')+CHAR(10)+CHAR(10)+ISNULL(comm.Agg_Comments,'') AS [Description]
	--id.*
