...
CREATE OR ALTER VIEW [vw_DW_CFG_LiteratureCategory_Interest] AS
SELECT 
NULL																AS [Id] -- Salesforce ID
,'LiteratureCategory'+CAST(LiteratureCategoryId AS NVARCHAR(50))	AS [Data_Warehouse_ID__c] -- nvarchar(120)
,LiteratureCategoryName												AS [Name] -- nvarchar(121)
...
,RC.UpdatedDate													    AS [LastModifiedDate]
	,CASE 
	 ...
	 ,RC.ActiveFlag													AS IsActive__c
FROM [TommiQA1].[dbo].[apfx_refLiteratureCategory] RC
