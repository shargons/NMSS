...
CREATE OR ALTER VIEW [vw_DW_CFG_ResourceCategory_Interest] AS
SELECT 
NULL																AS [Id] -- Salesforce ID
,'ResourceCategory'+CAST(ResourceCategoryId AS NVARCHAR(50))												AS [Data_Warehouse_ID__c] -- nvarchar(120)
,ResourceCategoryName												AS [Name] -- nvarchar(121)
...
FROM [TommiQA1].[dbo].apfx_refResourceCategory RC
