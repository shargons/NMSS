...
SELECT F.[ID]
      ...
      ,F.[CreatedById]
      ,F.[Status__c]
  INTO FA_Payment__c_Direct_2_Load
...
/******* Check Load table *********/
SELECT *
FROM FA_Payment__c_Direct_2_Load


/******* Change ID Column to nvarchar(18) *********/
ALTER TABLE FA_Payment__c_Direct_2_Load
...
/******* DBAmp Insert Script *********/
EXEC SF_TableLoader 'Insert:BULKAPI','CFG_NMSS_PREPROD','FA_Payment__c_Direct_2_Load'
...
INSERT INTO [CFG_NMSS_PREPROD].[dbo].[XREF_FAPayment]
           ([SFID]
           ,[DWID]
           ,[SystemOfCreation]
           ,[LastActionTaken]
...
--GO
INSERT INTO [dbo].[FAPayment_Lookup]
SELECT ID ,[DWUI_Interaction_ID__c] as LegacyID
FROM FA_Payment__c_Direct_2_Load_Result
where Error = 'Operation Successful.'
